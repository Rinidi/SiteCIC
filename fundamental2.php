...
<html lang="pt-br">
    ...
    <body>
        <div>
            <nav id="navSecundariaFundamental2" class="navbar fixed-top navbar-expand-lg navbar-dark ">                
        ...
        <div> 
            <nav id="navPrimariaFundamental2" class="navbar fixed-top navbar-expand-lg"> 
        ...
        <footer>
            ...
            <div class="barraFundamental2"></div>
            <div class="container">
