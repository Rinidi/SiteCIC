...
<html lang="pt-br">
    ...
    <body>
        <div>
            <nav id="navSecundariaMedio" class="navbar fixed-top navbar-expand-lg navbar-dark ">                
        ...
        <div> 
            <nav id="navPrimariaMedio" class="navbar fixed-top navbar-expand-lg"> 
