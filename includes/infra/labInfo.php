...
<html lang="pt-br">
    ...
    <body>
        ...
        <br/><br/>
        <article>
            <h3 class="title">Laboratório de Informática</h3>
            <div class="container justify-content-centerS">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-6">
                        <img class="img-thumbnail" src="../../img/infraestrutura/LabInfo/1.jpg"/>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-6">
                        <img class="img-thumbnail" src="../../img/infraestrutura/LabInfo/2.jpg"/>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-6">
                        <img class="img-thumbnail" src="../../img/infraestrutura/LabInfo/3.jpg"/>
                    </div>
                </div>
            </div>
        </article>
