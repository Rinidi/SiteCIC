                    ...
                    <div class="container">
                        ...
                        <div class="row mb-4 justify-content-center">
                            ...
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento1/0.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento1/0A.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento1/2.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento1/2A.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento1/3.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento1/3A.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento1/4.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento1/4E.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento1/5.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento1/5.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento1/6.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento1/6A.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                        </div>
        ...
        <div id="margin-top-bottom-md" class="container">
            <div class="row justify-content-center">
                <div class="botaoVoltar">
                    <a class="botaoVoltar" href="../eventos.php" role="button">
                            Voltar
                    </a>
                </div>
            </div>
