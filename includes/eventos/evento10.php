                    ...
                    <div class="container">
                        ...
                        <div class="row mb-4 justify-content-center">
                            ...
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/0.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/0.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/1.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/1.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/2.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/2E.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/3.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/3E.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/4.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/4E.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/5.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/5E.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/6.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/6E.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/7.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/7E.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/8.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/8.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/9.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/9.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/10.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/10E.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/11.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/11.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/12.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/12.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/13.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/13E.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento10/14.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento10/14E.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                        </div>
