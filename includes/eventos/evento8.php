        ...
        <div class="container" id="galery">
            <div class="row">
                ...
                <section id="galery" class="py-5">
                    <div class="container">
                        <h4 class="TEventos">"E quem disse que estudar Matemática é coisa chata?"</h4>
                        <div class="row mb-4 justify-content-start">
                            <div class="col-10">
                                <p class="txtEvt">
                                    Alunos do 6º e 7º ano do Ensino Fundamental, com a orientação da
                                    profª Terezinha trabalham, através jogos de memória e dominó,
                                    expressões algébricas e frações.
                                </p>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/0.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/0.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/1.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/1.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/2.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/2.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/3.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/3.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/4.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/4.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/5.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/5.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/6.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/6.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/7.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/7.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/8.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/8.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/9.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/9.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/10.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/10.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/11.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/11.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/12.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/12.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/13.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/13.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/14.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/14.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento8/15.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento8/15.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                        </div>
