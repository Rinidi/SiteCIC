        ...
        <div class="container" id="galery">
            <div class="row">
                ...
                <section id="galery" class="py-5">
                    <div class="container">
                        <h4 class="TEventos">Palestra sobre "Setembro Amarelo"</h4>

                        <div class="row mb-4 justify-content-center">
                            <div class="col-10">
                                <p class="txtEvt">
                                    Para o encerramento do mês de setembro tivemos a 
                                    honra de acolher a Psicóloga Andressa  Vince de 
                                    Oliveira, que ministrou a palestra sobre "Setembro Amarelo", 
                                    na qual ressaltou sobre a importância de refletir sobre a 
                                    prevenção ao suicídio. Muito obrigado a psicóloga Andressa 
                                    que muito colaborou conosco.
                                </p>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento13/0A.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento13/0A.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento13/1.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento13/1.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento13/2.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento13/2.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento13/3.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento13/3.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento13/4.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento13/4.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4"><br/>
                                <a href="../../img/eventos/evento13/5.jpg"
                                   data-toggle="lightbox" data-gallery="img-gallery">
                                    <img src="../../img/eventos/evento13/5.jpg"
                                         class="img-fluid rounded" id="ftGallery"/>
                                </a>
                            </div>
                        </div>
