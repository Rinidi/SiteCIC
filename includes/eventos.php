    ...
    <div class="container" id="galery">
        <div class="row">
            <section id="galery" class="py-5">
                <div class="container">
                    <h1 class="tittle align-center" style="font-size: 40pt;">Eventos</h1>
                    <br /><br />
                    <div class="row mb-4  justify-content-start">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
                            <a href="eventos/evento3.php">
                                <img id="imgEvt3" class="img-fluid" src="../img/eventos/evento3/0.jpg" alt="Alunos em frente faculdade de medicina" />
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
                            <a href="eventos/evento2.php">
                                <img id="imgEvt2" class="img-fluid" src="../img/eventos/evento2/0.jpg" alt="Crianças em frente a mural de mosaico" />
                        ...
                        <div id="divEvt1" class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
                            <a href="eventos/evento1.php">
                                <img id="imgEvt1" class="img-fluid" src="../img/eventos/evento1/0A.jpg" alt="Alunas mexendo com botânica" />
