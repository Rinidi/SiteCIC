    ...
    <div id="dataFooter" class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-2">
                <h6 class="hRodape"><br />Níveis de Ensino</h6>
            ...
            <div id="FaleConosco" class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
                <h6 class="hRodape"><br />Fale Conosco</h6>
            ...
            <div class="col-8 col-sm-8 col-md-6 col-lg-3 col-xl-3">
                ...
                <div class="row justify-content-start">
                    ...
                    <div id="linkLogo" class="col-12">
                        <a class="linkLogo" id="linkInstaCic" href="https://www.instagram.com/cic_brazopolis/" target="_blank">
                            <img id="logoInsta" src="../img/logo-insta.png" lat="Logo Instagram" height="45px" />
                            cic_brazopolis
                        </a>
                    </div>
                </div>
