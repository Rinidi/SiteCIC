    ...
    <body>
        ...
        <!--<div id="car">
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="../img/fundamental1/1.jpg" alt="Crianças em sala">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../img/fundamental1/2.jpg" alt="Meninas na Sala">
                        <div class="carousel-caption d-none d-md-block">
                            <h3>Foto referente ao ensino fundamental I</h5>
                                <p>*Comentário a mais sobre ao ensino fundamental I na instituição*</p>
                        </div>
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../img/fundamental1/4.jpg" alt="Outra Sala de aula com crianças">
                        <div class="carousel-caption d-none d-md-block">
                            <h3>Foto referente ao ensino fundamental I</h5>
                                <p>*Comentário a mais sobre ao ensino fundamental I na instituição*</p>
                        </div>
